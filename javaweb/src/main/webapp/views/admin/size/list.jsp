...
<body>
	...
	<!-- Main content -->
	<form action="<c:url value='/admin-size'/>" method="get" id="formSubmit">
										...
										<c:forEach var="item" items="${model.listResult}">
											<tr class="alert" role="alert">
												...
												<td class="d-flex flex-row-reverse">
													<a href="<c:url value='/admin-size?action=delete&id=${item.id}'/>" >
														<button type="button" class="btn btn-danger" >
															<span aria-hidden="true"><i class="fa fa-close"></i></span>
														</button>
													</a>
													<a href="<c:url value='/admin-size?action=edit&id=${item.id}' />">

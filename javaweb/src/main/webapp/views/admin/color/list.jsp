...
<body>
	...
	<!-- Main content -->
	<form action="<c:url value='/admin-color'/>" method="get"
		id="formSubmit">
									...
									<tbody>
										<c:forEach var="item" items="${model.listResult}">
											<tr class="alert" role="alert">
												...
												<td>${item.code}</td>
												<td>
													<a href="<c:url value='/admin-color?action=delete&id=${item.id}'/>" >
														<button type="button" class="btn btn-danger" >
															<span aria-hidden="true"><i class="fa fa-close"></i></span>
														</button>
													</a>
													<a href="<c:url value='/admin-color?action=edit&id=${item.id}' />">

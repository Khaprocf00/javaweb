...
<body>
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">
						<a href="<c:url value='/admin-tag'/>">tag</a>
					</h1>
				</div>
				<!-- /.col -->
				<div class="col-sm-6">
	...
	<!-- Main content -->
	<form action="<c:url value='/admin-tag'/>" method="get" id="formSubmit">
										...
										<c:forEach var="item" items="${model.listResult}">
											<tr class="alert" role="alert">
												...
												<td class="d-flex flex-row-reverse">
													<a href="<c:url value='/admin-tag?action=delete&id=${item.id}'/>" >
														<button type="button" class="btn btn-danger" >
															<span aria-hidden="true"><i class="fa fa-close"></i></span>
														</button>
													</a>
													<a href="<c:url value='/admin-tag?action=edit&id=${item.id}' />">

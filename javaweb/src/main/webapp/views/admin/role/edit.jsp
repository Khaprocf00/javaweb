...
<body>
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">
						<a href="<c:url value='/admin-role'/>">role</a>
					</h1>
				</div>
				<!-- /.col -->
				<div class="col-sm-6">
	...
	<div class="container">
		<form action="" method="POST" id="formSubmit">
			...
			<div class="form-group">
				<label for="name">Name role</label> <input type="text"
					name="name" value="${model.name}" class="form-control" id="name"
					placeholder="Enter name brand">
			</div>
			<div class="form-group">
				<label for="code">Code role</label> <input type="text"
			...
			<c:if test="${check == false}">
					<div class="alert alert-danger mt-2" role="alert">Name "${role.name}" hoặc Code "${role.code}"
						này đã có rồi !</div>
				</c:if>

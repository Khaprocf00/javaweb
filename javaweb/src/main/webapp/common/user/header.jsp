				...
				<div class="switcher">
					<ul>
						<li class="languages"><a href="#"><img
								src="<c:url value='template/user/assets/img/logo/fontlogo.jpg'/> "
							...
							<ul class="dropdown_languages">
								<li><a href="#"><img
										...
										alt=""> English</a></li>
								<li><a href="#"><img
										src="<c:url value='template/user/assets/img/logo/fontlogo2.jpg'/> "
										alt=""> French </a></li>
							</ul></li>
			...
			<div class="col-lg-3 col-md-3">
				<div class="logo">
					<a href="index.html"><img
						src="<c:url value='template/user/assets/img/logo/logo.jpg'/> "
						alt=""></a>
				</div>
			</div>
			<!--logo end-->
					...
					<div class="shopping_cart">
						...
						<div class="mini_cart">
							<div class="cart_item">
								<div class="cart_img">
									<a href="#"><img
										src="<c:url value='template/user/assets/img/cart/cart.jpg'/> "
										alt=""></a>
								</div>
								<div class="cart_info">
							...
							<div class="cart_item">
								<div class="cart_img">
									<a href="#"><img
										src="<c:url value='template/user/assets/img/cart/cart2.jpg'/> "
										alt=""></a>
								</div>
								<div class="cart_info">
									...
									<div class="mega_menu">
										...
										<div class="mega_bottom fix">
											<div class="mega_thumb">
												<a href="#"><img
													src="<c:url value='template/user/assets/img/banner/banner1.jpg '/>"
													alt=""></a>
											</div>
											<div class="mega_thumb">
												<a href="#"><img
													src="<c:url value='template/user/assets/img/banner/banner2.jpg '/>"
													alt=""></a>
											</div>
										</div>
									</div></li>
								<li><a href="#">men</a>
									<div class="mega_menu">
										<div class="mega_top fix">
											...
											<div class="mega_items">
												<a href="#"><img
													src="<c:url value='template/user/assets/img/banner/banner3.jpg '/>"
													alt=""></a>
											</div>
										</div>
